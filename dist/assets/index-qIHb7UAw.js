 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aa(){var e;return typeof self<"u"&&((e=self.location)===null||e===void 0?void 0:e.href)||""}function Hb(){return Ql()==="http:"||Ql()==="https:"}function Ql(){var e;return typeof self<"u"&&((e=self.location)===null||e===void 0?void 0:e.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jb(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Hb()||by()||"connection"in navigator)?navigator.onLine:!0}function zb(){if(typeof navigator>"u")return null;const e=navigator;return e.languages&&e.languages[0]||e.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(t,n){this.shortDelay=t,this.longDelay=n,Bt(n>t,"Short delay should be less than long delay!"),this.isMobile=yy()||_y()}get(){return jb()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eh(e,t,n=!1){if(lt(e.app))return Promise.reject(kt(e));const r="signIn",i=await wh(e,r,t),s=await jn._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(s.user),s}async function F2(e,t){return Eh(Sn(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ch(e){const t=Sn(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function U2(e,t,n){const r=Sn(e),i={requestType:"PASSWORD_RESET",email:t,clientType:"CLIENT_TYPE_WEB"};n&&$2(r,i,n),await ys(r,i,"getOobCode",A2)}async function B2(e,t,n){if(lt(e.app))return Promise.reject(kt(e));const r=Sn(e),o=await ys(r,{returnSecureToken:!0,email:t,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",N2).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Ch(e),c}),a=await jn._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(a.user),a}function H2(e,t,n){return lt(e.app)?Promise.reject(kt(e)):F2(it(e),Cr.credential(t,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Ch(e),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function j2(e,t){return pt(e,"POST","/v1/accounts:update",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/HomePage-rO4HHuq6.js","assets/ProductItem-w8g3VCMz.js","assets/ProductItem-LrONpSoB.css","assets/HomePage-oBP4377j.css","assets/RegisterPage-rD1WWQSe.js","assets/authValidations-M9u6W4xn.js","assets/index-AfUwVyS9.js","assets/TipsElement-DI4QNa5t.js","assets/TipsElement-LoqjZZwu.css","assets/RegisterPage-3m6q21TB.css","assets/LoginPage-SVvAqjVj.js","assets/LoginPage-hF-xJ2Hf.css","assets/RememberPage-AYIz3yMy.js","assets/RememberPage-BAH9PlQD.css","assets/CategoryPage-wqqtVaTD.js","assets/CategoryPage-JO-cnUb-.css","assets/ProductPage-oGP9FHfT.js","assets/ProductPage-unBpUBac.css","assets/CheckOutPage-N8JyLnob.js","assets/orderInfo-gxWBiTqK.js","assets/CheckOutPage-NHqPdlhd.css","assets/UserPage-6BU41lfe.js","assets/UserPage-YVuqGV6d.css","assets/ConfirmPage-E1l4da69.js","assets/ThankPage-hY6qd74s.js","assets/ThankPage-KGlmDs3G.css"]
  }
